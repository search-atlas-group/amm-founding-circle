...
| Folder | What's in it |
|---|---|
| [`skills/`](skills/README.md) | **36 skills** — start at the index. Group A: 16 AEO/SEO (a chained client workflow). Group B: 19 agentic-engineering skills. Group C: security. |
